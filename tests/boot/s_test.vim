...
function! s:Test_to_camel_case()
    ...
    Assert 'ABCD' !=# 'abcd'
    Assert 'abcd' !=# 'ABCD'
    Assert L_s('').to_camel_case().str ==# ''
    Assert L_s('1').to_camel_case().str ==# '1'
    Assert L_s('b').to_camel_case().str ==# 'b'
    Assert L_s('B').to_camel_case().str ==# 'b'
    Assert L_s('A').to_camel_case().str ==# 'a'
    Assert L_s('your').to_camel_case().str ==# 'your'
    Assert L_s('Your').to_camel_case().str ==# 'your'
    Assert L_s('yourMom').to_camel_case().str ==# 'yourMom'
    Assert L_s('YourMom').to_camel_case().str ==# 'yourMom'
    Assert L_s('yourmom').to_camel_case().str ==# 'yourmom'
    Assert L_s('Yourmom').to_camel_case().str ==# 'yourmom'
    Assert L_s('your_mom').to_camel_case().str ==# 'yourMom'
    Assert L_s('your_mommas_mom').to_camel_case().str ==# 'yourMommasMom'
    Assert L_s('Your_Mommas_Mom').to_camel_case().str ==# 'yourMommasMom'
    Assert L_s('theDb').to_camel_case().str ==# 'theDb'
    Assert L_s('TheDb').to_camel_case().str ==# 'theDb'
    Assert L_s('theDB').to_camel_case().str ==# 'theDb'
    Assert L_s('theDB').to_camel_case().str ==# 'theDb'
    Assert L_s('2burritos').to_camel_case().str ==# '2Burritos'
    Assert L_s('2Burritos').to_camel_case().str ==# '2Burritos'
    Assert L_s('eat5tacos').to_camel_case().str ==# 'eat5Tacos'
    Assert L_s('eat5Tacos').to_camel_case().str ==# 'eat5Tacos'
    Assert L_s('Eat5tacos').to_camel_case().str ==# 'eat5Tacos'
    Assert L_s('Eat5Tacos').to_camel_case().str ==# 'eat5Tacos'
    Assert L_s('9lives').to_camel_case().str ==# '9Lives'
    Assert L_s('9Lives').to_camel_case().str ==# '9Lives'
    Assert L_s('99redBalloons').to_camel_case().str ==# '99RedBalloons'
    Assert L_s('99RedBalloons').to_camel_case().str ==# '99RedBalloons'
    Assert L_s('high5').to_camel_case().str ==# 'high5'
    Assert L_s('High5').to_camel_case().str ==# 'high5'
    Assert L_s('itsOver9000').to_camel_case().str ==# 'itsOver9000'
    Assert L_s('ItsOver9000').to_camel_case().str ==# 'itsOver9000'
    Assert L_s('two20two').to_camel_case().str ==# 'two20Two'
    Assert L_s('Two20two').to_camel_case().str ==# 'two20Two'
    Assert L_s('_usedToIndicatePrivate').to_camel_case().str ==# '_usedToIndicatePrivate'
    Assert L_s('_UsedToIndicatePrivate').to_camel_case().str ==# '_usedToIndicatePrivate'
    Assert L_s('_used_to_indicate_private').to_camel_case().str ==# '_usedToIndicatePrivate'
endfunction
...
function! s:Test_smart_to_camel_or_pascal_case()
    Assert L_s('').smart_to_camel_or_pascal_case().str ==# ''
    Assert L_s('_').smart_to_camel_or_pascal_case().str ==# '_'
    Assert L_s('7').smart_to_camel_or_pascal_case().str ==# '7'
    Assert L_s('b').smart_to_camel_or_pascal_case().str ==# 'B'
    Assert L_s('B').smart_to_camel_or_pascal_case().str ==# 'b'
    Assert L_s('var').smart_to_camel_or_pascal_case().str ==# 'Var'
    Assert L_s('Var').smart_to_camel_or_pascal_case().str ==# 'var'
    Assert L_s('var_').smart_to_camel_or_pascal_case().str ==# 'var'
    Assert L_s('var_name').smart_to_camel_or_pascal_case().str ==# 'varName'
    Assert L_s('Var_Name').smart_to_camel_or_pascal_case().str ==# 'VarName'
    Assert L_s('Var_name').smart_to_camel_or_pascal_case().str ==# 'VarName'
    Assert L_s('yourMom').smart_to_camel_or_pascal_case().str ==# 'YourMom'
    Assert L_s('YourMom').smart_to_camel_or_pascal_case().str ==# 'yourMom'
    Assert L_s('YourMommasMom').smart_to_camel_or_pascal_case().str ==# 'yourMommasMom'
    Assert L_s('yourMommasMom').smart_to_camel_or_pascal_case().str ==# 'YourMommasMom'
    Assert L_s('eat5tacos').smart_to_camel_or_pascal_case().str ==# 'Eat5Tacos'
    Assert L_s('eat5Tacos').smart_to_camel_or_pascal_case().str ==# 'Eat5Tacos'
    Assert L_s('Eat5Tacos').smart_to_camel_or_pascal_case().str ==# 'eat5Tacos'
    Assert L_s('Eat5tacos').smart_to_camel_or_pascal_case().str ==# 'eat5Tacos'
    Assert L_s('Eat10eggs').smart_to_camel_or_pascal_case().str ==# 'eat10Eggs'
    Assert L_s('Eat10Eggs').smart_to_camel_or_pascal_case().str ==# 'eat10Eggs'
    Assert L_s('eat10Eggs').smart_to_camel_or_pascal_case().str ==# 'Eat10Eggs'
    Assert L_s('eat10eggs').smart_to_camel_or_pascal_case().str ==# 'Eat10Eggs'
    Assert L_s('Eat100chickens').smart_to_camel_or_pascal_case().str ==# 'eat100Chickens'
    Assert L_s('Eat100Chickens').smart_to_camel_or_pascal_case().str ==# 'eat100Chickens'
    Assert L_s('eat100Chickens').smart_to_camel_or_pascal_case().str ==# 'Eat100Chickens'
    Assert L_s('eat100chickens').smart_to_camel_or_pascal_case().str ==# 'Eat100Chickens'
    Assert L_s('three_part_name').smart_to_camel_or_pascal_case().str ==# 'threePartName'
    Assert L_s('three_Part_name').smart_to_camel_or_pascal_case().str ==# 'threePartName'
    Assert L_s('three_part_Name').smart_to_camel_or_pascal_case().str ==# 'threePartName'
    Assert L_s('Three_part_name').smart_to_camel_or_pascal_case().str ==# 'ThreePartName'
    Assert L_s('Three_Part_name').smart_to_camel_or_pascal_case().str ==# 'ThreePartName'
    Assert L_s('Three_part_Name').smart_to_camel_or_pascal_case().str ==# 'ThreePartName'
    Assert L_s('Three_Part_Name').smart_to_camel_or_pascal_case().str ==# 'ThreePartName'
    Assert L_s('1Tick').smart_to_camel_or_pascal_case().str ==# '1Tick'
    Assert L_s('1tick').smart_to_camel_or_pascal_case().str ==# '1Tick'
    Assert L_s('99Earworms').smart_to_camel_or_pascal_case().str ==# '99Earworms'
    Assert L_s('99earworms').smart_to_camel_or_pascal_case().str ==# '99Earworms'
    Assert L_s('whatIs5Plus2MyDude').smart_to_camel_or_pascal_case().str ==# 'WhatIs5Plus2MyDude'
    Assert L_s('whatIs5plus2myDude').smart_to_camel_or_pascal_case().str ==# 'WhatIs5Plus2MyDude'
    Assert L_s('WhatIs5Plus2MyDude').smart_to_camel_or_pascal_case().str ==# 'whatIs5Plus2MyDude'
    Assert L_s('WhatIs5Plus2MyDude').smart_to_camel_or_pascal_case().str ==# 'whatIs5Plus2MyDude'
    Assert L_s('WhatIs5plus2myDude').smart_to_camel_or_pascal_case().str ==# 'whatIs5Plus2MyDude'
    Assert L_s('_usedToIndicatePrivate').smart_to_camel_or_pascal_case().str ==# '_usedToIndicatePrivate'
    Assert L_s('_UsedToIndicatePrivate').smart_to_camel_or_pascal_case().str ==# '_usedToIndicatePrivate'
    Assert L_s('_used_to_indicate_private').smart_to_camel_or_pascal_case().str ==# '_usedToIndicatePrivate'
endfunction
